  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-emerald-50 pt-16 px-4">
      <div className="max-w-7xl mx-auto py-6">
        ...
        {/* FAIR3 Token Rewards Box */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.3 }}
          className="mt-8 bg-gradient-to-r from-emerald-600 to-teal-600 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all"
        >
          <div className="text-center text-white">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-2xl font-bold">FAIR3 Token Rewards</h3>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="bg-white bg-opacity-10 p-4 rounded-lg">
                <p className="text-sm opacity-90">Based on Inflow</p>
                <p className="text-2xl font-bold">$27,300</p>
                <p className="text-sm opacity-75">Eligible for rewards</p>
              </div>
              
              <div className="bg-white bg-opacity-10 p-4 rounded-lg">
                <p className="text-sm opacity-90">Based on Outflow</p>
                <p className="text-2xl font-bold">$24,000</p>
                <p className="text-sm opacity-75">Transaction volume</p>
              </div>
              
              <div className="bg-white bg-opacity-10 p-4 rounded-lg">
                <p className="text-sm opacity-90">Estimated Rewards</p>
                <p className="text-2xl font-bold">1,250 FAIR3</p>
                <p className="text-sm opacity-75">~$625 USD</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center space-x-4 mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm">Rewards Loading...</span>
              </div>
              <div className="flex items-center">
            ...
            <div className="bg-white bg-opacity-10 p-4 rounded-lg">
              <p className="text-sm mb-2">🎉 <strong>Feature Coming Soon!</strong></p>
              <p className="text-xs opacity-90">
                Earn FAIR3 tokens based on your invoice activity. Higher inflow and consistent outflow 
                will earn you more rewards. Stay tuned for the official launch!
              </p>
            </div>

            <div className="mt-6 flex justify-center">
              <button className="bg-white text-emerald-600 px-6 py-2 rounded-lg font-semibold hover:bg-opacity-90 transition-all transform hover:scale-105">
                Learn More About FAIR3
              </button>
            </div>
          </div>
        </motion.div>
